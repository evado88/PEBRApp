...
class ZambiaPhoneNumberTextInputFormatter extends TextInputFormatter {
  @override
...
String validatePhoneNumber(String value) {
  final RegExp phoneExp = RegExp(r'^\d\d\d\d\d\d\d\d\d$');
  if (!phoneExp.hasMatch(value)) return 'Enter a valid Zambia phone number...';
  return null;
}

class StudyNumberTextInputFormatter extends TextInputFormatter {
  @override
  TextEditingValue formatEditUpdate(
    TextEditingValue oldValue,
    TextEditingValue newValue,
...
String validateStudyNumber(String value) {
  final RegExp artNumberExp = RegExp(r'^\d\d\d\d\d$');
  if (!artNumberExp.hasMatch(value)) return 'Enter a valid Study number';
  return null;
}
